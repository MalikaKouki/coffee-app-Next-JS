    ...
    <div className="bg-white rounded-lg shadow-md p-4 relative z-[50] flex flex-col justify-between gap-2">
      ...
      <p className="text-[12px] text-gray-900 flex items-center gap-2">
        <span className="font-bold flex items-center gap-1">
          <RiRedPacketFill /> Quantité:
        </span>
        <span>Packet de {item.quantityPack}g</span>
      </p>
      <p className="text-[12px] text-gray-900 flex items-center gap-2">
        <span className="font-bold flex items-center gap-1">
          <BiSolidCoffeeBean /> Puissance:
        </span>
      ...
      <button onClick={handleAddToCart} className="bg-orange-400 hover:bg-orange-600 rounded-md text-white p-2" style={{ height: 40, width:250 }}>Ajouter au panier</button>
      </div>
    </div>
